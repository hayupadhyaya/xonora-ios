...
public struct ClientHelloPayload: Codable, Sendable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case playerV1SupportLegacy = "player_support" // Legacy field for backward compatibility
    ...
    // Custom decoding to support both old and new field names
    public init(from decoder: Decoder) throws {
        ...
        supportedRoles = try container.decode([VersionedRole].self, forKey: .supportedRoles)
        metadataV1Support = try container.decodeIfPresent(MetadataSupport.self, forKey: .metadataV1Support)
        artworkV1Support = try container.decodeIfPresent(ArtworkSupport.self, forKey: .artworkV1Support)
        visualizerV1Support = try container.decodeIfPresent(VisualizerSupport.self, forKey: .visualizerV1Support)

        // Try new field name first, fall back to legacy name
        if let playerSupport = try container.decodeIfPresent(PlayerSupport.self, forKey: .playerV1Support) {
            playerV1Support = playerSupport
        } else if let playerSupport = try container.decodeIfPresent(PlayerSupport.self, forKey: .playerV1SupportLegacy) {
            playerV1Support = playerSupport
        } else {
            playerV1Support = nil
        }
    ...
    // Custom encoding to support both field names for maximum compatibility
    public func encode(to encoder: Encoder) throws {
        ...
        // Encode both field names for backward compatibility
        // New MA expects "player@v1_support", old MA expects "player_support"
        try container.encodeIfPresent(playerV1Support, forKey: .playerV1Support)
        try container.encodeIfPresent(playerV1Support, forKey: .playerV1SupportLegacy)

        try container.encodeIfPresent(metadataV1Support, forKey: .metadataV1Support)
        try container.encodeIfPresent(artworkV1Support, forKey: .artworkV1Support)
        try container.encodeIfPresent(visualizerV1Support, forKey: .visualizerV1Support)
    }
}
